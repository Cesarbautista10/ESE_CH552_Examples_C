      ...
      0002AC                        569 _DLY_us:
                           ...
                           000001   576 	ar1 = 0x01
                           000000   577 	ar0 = 0x00
      0002AC AE 82            [24]  578 	mov	r6,dpl
      0002AE AF 83            [24]  579 	mov	r7,dph
                                    580 ;	src/delay.c:24: while(n) {                        // total = 12~13 Fsys cycles, 1uS @Fsys=12MHz
      0002B0                        581 00101$:
      0002B0 EE               [12]  582 	mov	a,r6
      0002B1 4F               [12]  583 	orl	a,r7
      0002B2 60 16            [24]  584 	jz	00104$
                                    585 ;	src/delay.c:25: SAFE_MOD++;                     // 2 Fsys cycles, for higher Fsys, add operation here
      0002B4 E5 A1            [12]  586 	mov	a,_SAFE_MOD
      0002B6 04               [12]  587 	inc	a
      0002B7 F5 A1            [12]  588 	mov	_SAFE_MOD,a
                                    589 ;	src/delay.c:28: SAFE_MOD++;
      0002B9 E5 A1            [12]  590 	mov	a,_SAFE_MOD
      0002BB 04               [12]  591 	inc	a
      0002BC F5 A1            [12]  592 	mov	_SAFE_MOD,a
                                    593 ;	src/delay.c:31: SAFE_MOD++;
      0002BE E5 A1            [12]  594 	mov	a,_SAFE_MOD
      0002C0 04               [12]  595 	inc	a
      0002C1 F5 A1            [12]  596 	mov	_SAFE_MOD,a
                                    597 ;	src/delay.c:58: n--;
      0002C3 1E               [12]  598 	dec	r6
      0002C4 BE FF 01         [24]  599 	cjne	r6,#0xff,00116$
      0002C7 1F               [12]  600 	dec	r7
      0002C8                        601 00116$:
      0002C8 80 E6            [24]  602 	sjmp	00101$
      0002CA                        603 00104$:
                                    604 ;	src/delay.c:60: }
      0002CA 22               [24]  605 	ret
                                    606 ;------------------------------------------------------------
                                    ...
                                    614 ;	-----------------------------------------
      0002CB                        615 _DLY_ms:
      0002CB AE 82            [24]  616 	mov	r6,dpl
      0002CD AF 83            [24]  617 	mov	r7,dph
                                    618 ;	src/delay.c:66: while(n) {
      0002CF                        619 00101$:
      0002CF EE               [12]  620 	mov	a,r6
      0002D0 4F               [12]  621 	orl	a,r7
      0002D1 60 15            [24]  622 	jz	00104$
                                    623 ;	src/delay.c:67: DLY_us(1000);
      0002D3 90 03 E8         [24]  624 	mov	dptr,#0x03e8
      0002D6 C0 07            [24]  625 	push	ar7
      0002D8 C0 06            [24]  626 	push	ar6
      0002DA 12 02 AC         [24]  627 	lcall	_DLY_us
      0002DD D0 06            [24]  628 	pop	ar6
      0002DF D0 07            [24]  629 	pop	ar7
                                    630 ;	src/delay.c:68: n--;
      0002E1 1E               [12]  631 	dec	r6
      0002E2 BE FF 01         [24]  632 	cjne	r6,#0xff,00116$
      0002E5 1F               [12]  633 	dec	r7
      0002E6                        634 00116$:
      0002E6 80 E7            [24]  635 	sjmp	00101$
      0002E8                        636 00104$:
                                    637 ;	src/delay.c:70: }
      0002E8 22               [24]  638 	ret
                                    639 ;------------------------------------------------------------
                                    ...
                                    647 ;	-----------------------------------------
      0002E9                        648 __delay_more_cycles:
                                    649 ;	naked function: no prologue.
                                    650 ;	src/delay.c:85: __endasm;
      0002EA                        651 	.even	; make predictable cycles for jumps
      0002EA C0 07            [24]  652 	push	ar7 ; 2 cycles
      0002EC AF 82            [24]  653 	mov	r7, dpl ; 2 cycles
      0002EE DF FE            [24]  654 	djnz	r7, .+0 ; 2/4 cycles
      0002F0 D0 07            [24]  655 	pop	ar7 ; 2 cycles
      0002F2 22               [24]  656 	ret	; 4|5 cycles
                                    657 ;	src/delay.c:86: }
