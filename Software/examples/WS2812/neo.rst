      ...
      000225                        619 	.even
      000225 7F 08            [12]  620 	mov	r7, #8 ; 2 CLK - 8 bits to transfer
      000227 C5 82            [12]  621 	xch	a, dpl ; 2 CLK - data byte -> accu
      000229                        622 01$:
      000229 33               [12]  623 	rlc	a ; 1 CLK - data bit -> carry (MSB first)
      00022A D2 00            [12]  624 	setb	_PPIN_NEO ; 2 CLK - NEO pin HIGH
      00022C 92 00            [24]  625 	mov	_PPIN_NEO, c ; 2 CLK - "0"-bit? -> NEO pin LOW now
      00022E 00               [12]  626 	nop	
      00022F 00               [12]  627 	nop 
      000230 00               [12]  628 	nop 
      000231 00               [12]  629 	nop 
      000232 00               [12]  630 	nop 
      000233 00               [12]  631 	nop ; x CLK - TH1 delay
      000234 C2 00            [12]  632 	clr	_PPIN_NEO ; 2 CLK - "1"-bit? -> NEO pin LOW a little later
      000236 00               [12]  633 	nop	
      000237 00               [12]  634 	nop ; y CLK - TCT delay
      000238 DF EF            [24]  635 	djnz	r7, 01$ ; 2/4|5|6 CLK - repeat for all bits
                                    636 ;	src/neo.c:97: }
      00023A 22               [24]  637 	ret
                                    638 ;------------------------------------------------------------
                                    ...
                                    648 ;	-----------------------------------------
      00023B                        649 _NEO_writeColor:
      00023B AF 82            [24]  650 	mov	r7,dpl
                                    651 ;	src/neo.c:104: NEO_sendByte(g); NEO_sendByte(r); NEO_sendByte(b);
      00023D 85 0A 82         [24]  652 	mov	dpl,_NEO_writeColor_PARM_2
      000240 C0 07            [24]  653 	push	ar7
      000242 12 02 25         [24]  654 	lcall	_NEO_sendByte
      000245 D0 07            [24]  655 	pop	ar7
      000247 8F 82            [24]  656 	mov	dpl,r7
      000249 12 02 25         [24]  657 	lcall	_NEO_sendByte
      00024C 85 0B 82         [24]  658 	mov	dpl,_NEO_writeColor_PARM_3
                                    659 ;	src/neo.c:110: }
      00024F 02 02 25         [24]  660 	ljmp	_NEO_sendByte
                                    661 ;------------------------------------------------------------
                                    ...
                                    673 ;	-----------------------------------------
      000252                        674 _NEO_writeHue:
                                    675 ;	src/neo.c:116: uint8_t phase = hue >> 6;
      000252 E5 82            [12]  676 	mov	a,dpl
      000254 FF               [12]  677 	mov	r7,a
      000255 23               [12]  678 	rl	a
      000256 23               [12]  679 	rl	a
      000257 54 03            [12]  680 	anl	a,#0x03
      000259 FE               [12]  681 	mov	r6,a
                                    682 ;	src/neo.c:117: uint8_t step  = (hue & 63) << bright;
      00025A 53 07 3F         [24]  683 	anl	ar7,#0x3f
      00025D AD 0C            [24]  684 	mov	r5,_NEO_writeHue_PARM_2
      00025F 8D F0            [24]  685 	mov	b,r5
      000261 05 F0            [12]  686 	inc	b
      000263 EF               [12]  687 	mov	a,r7
      000264 80 02            [24]  688 	sjmp	00122$
      000266                        689 00120$:
      000266 25 E0            [12]  690 	add	a,acc
      000268                        691 00122$:
      000268 D5 F0 FB         [24]  692 	djnz	b,00120$
      00026B FF               [12]  693 	mov	r7,a
                                    694 ;	src/neo.c:118: uint8_t nstep = (63 << bright) - step;
      00026C 8D F0            [24]  695 	mov	b,r5
      00026E 05 F0            [12]  696 	inc	b
      000270 74 3F            [12]  697 	mov	a,#0x3f
      000272 80 02            [24]  698 	sjmp	00125$
      000274                        699 00123$:
      000274 25 E0            [12]  700 	add	a,acc
      000276                        701 00125$:
      000276 D5 F0 FB         [24]  702 	djnz	b,00123$
      000279 8F 04            [24]  703 	mov	ar4,r7
      00027B C3               [12]  704 	clr	c
      00027C 9C               [12]  705 	subb	a,r4
      00027D FD               [12]  706 	mov	r5,a
                                    707 ;	src/neo.c:119: switch(phase) {
      00027E BE 00 02         [24]  708 	cjne	r6,#0x00,00126$
      000281 80 0A            [24]  709 	sjmp	00101$
      000283                        710 00126$:
      000283 BE 01 02         [24]  711 	cjne	r6,#0x01,00127$
      000286 80 0F            [24]  712 	sjmp	00102$
      000288                        713 00127$:
                                    714 ;	src/neo.c:120: case 0:   NEO_writeColor(nstep,  step,     0); break;
      000288 BE 02 20         [24]  715 	cjne	r6,#0x02,00106$
      00028B 80 14            [24]  716 	sjmp	00103$
      00028D                        717 00101$:
      00028D 8F 0A            [24]  718 	mov	_NEO_writeColor_PARM_2,r7
      00028F 75 0B 00         [24]  719 	mov	_NEO_writeColor_PARM_3,#0x00
      000292 8D 82            [24]  720 	mov	dpl,r5
                                    721 ;	src/neo.c:121: case 1:   NEO_writeColor(    0, nstep,  step); break;
      000294 02 02 3B         [24]  722 	ljmp	_NEO_writeColor
      000297                        723 00102$:
      000297 8D 0A            [24]  724 	mov	_NEO_writeColor_PARM_2,r5
      000299 8F 0B            [24]  725 	mov	_NEO_writeColor_PARM_3,r7
      00029B 75 82 00         [24]  726 	mov	dpl,#0x00
                                    727 ;	src/neo.c:122: case 2:   NEO_writeColor( step,     0, nstep); break;
      00029E 02 02 3B         [24]  728 	ljmp	_NEO_writeColor
      0002A1                        729 00103$:
      0002A1 75 0A 00         [24]  730 	mov	_NEO_writeColor_PARM_2,#0x00
      0002A4 8D 0B            [24]  731 	mov	_NEO_writeColor_PARM_3,r5
      0002A6 8F 82            [24]  732 	mov	dpl,r7
                                    733 ;	src/neo.c:124: }
                                    734 ;	src/neo.c:125: }
      0002A8 02 02 3B         [24]  735 	ljmp	_NEO_writeColor
      0002AB                        736 00106$:
      0002AB 22               [24]  737 	ret
                                    738 	.area CSEG    (CODE)
                                    739 	.area CONST   (CODE)
